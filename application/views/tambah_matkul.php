                                ...
                                <div class="col-sm-10">
                                    <div class="dropdown">
                                        ...
                                        <!-- <?php var_dump($nama_kelas)?> -->
                                            <?php foreach($nama_matkul as $row):?>
        ...
        jQuery.noConflict()(function ($) { // this was missing for me
            $(document).ready(function() { 
                ...
                $("#pilih").on('click','li',function (){
                    ...
                    $.ajax({
                        url : '<?php echo base_url()?>Admin/ajax_matkul',
                        data : 'nama='+selText,
                        success : function(data){
                            var json = data,
                            obj = JSON.parse(json);
                            // alert(selText);
                            $("#dropdownMenuButton").text(obj.nama_matkul);
                            $("#kode").val(obj.kode);
                            $("#form-euy").attr('action', '<?php echo base_url()?>Admin/add_matkul/<?= $this->session->userdata("nidn");?>');
                        }
                    });
                });
            });
