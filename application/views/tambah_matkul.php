        ...
        <div class="body" style="margin-top: 100px;"></div>
            ...
            <div class="container">
                <div class="row mt-5">
                    <div class="col-2"></div>
                    <div class="col-8">
                    <form id="form-euy" method="post" action="<?php echo base_url()?>admin/add_matkul">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">ID Matkul</label>
                                <div class="col-sm-10">
                                    <input id="id" type="text" class="form-control" value="<?php echo $id[0]["id_matkul"]+1;?>" name="id" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Nama Matakuliah</label>
                                <div class="col-sm-10">
                                    <input id="nama" type="text" class="form-control" placeholder="Nama Matakuliah" name="nama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Kode Matakuliah</label>
                                <div class="col-sm-10">
                                    <input id="kode" type="text" class="form-control" placeholder="Kode Matakuliah" name="kode">
                                </div>
                            </div>
